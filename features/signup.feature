Feature: Signup
    ...
    # Wireframe: ./wireframes/signup__start.png
    ...
    # Wireframe: ./wireframes/signup__create-user.png
    ...
    # Wireframe:  ./wireframes/signup__valid-entries.png
    ...
    # Wireframe: ./wireframes/signup__user-creation-cancelled.png
    ...
    # Wireframe: ./wireframes/signup__invalid-entries.png
